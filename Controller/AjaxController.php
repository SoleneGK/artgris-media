...
class AjaxController extends AbstractController
{
    ...
    public function ajaxIcon(Request $request): JsonResponse
    {
    ...
    public function ajaxCrop(Request $request): JsonResponse
    {
        ...
        if ($destinationFolder !== null) {
            ...
            $savedPath = $image->save(
                $rootdir . DIRECTORY_SEPARATOR . $destinationFolder . $croppedPath . urldecode($filename)
                . $cropStrAdd . uniqid('', true) . '.' . $extension,
                'guess',
                85
            );
